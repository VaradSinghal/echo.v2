                            ...
                            {Object.entries(
                                ...
                                <div key={repoId} className={cn(
                                    ...
                                    <div className="flex items-center justify-between mb-4 border-b-2 border-black pb-2">
                                        <p className="font-black uppercase tracking-widest text-xs truncate max-w-[200px]">
                                            {repoId.split('/').pop()}
                                        </p>
                                        <Badge className="bg-black text-white rounded-none text-[8px]">
                                    ...
                                    <div className="space-y-3">
                                        {posts.map((item: any) => (
                                            <div key={item.id} className="flex items-center justify-between gap-4">
                                                <p className="text-[10px] font-bold uppercase tracking-tight text-black/60 truncate italic">
                                                    {item.posts?.title}
                                                </p>
